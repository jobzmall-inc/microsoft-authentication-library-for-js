...
export class PopupClient extends StandardInteractionClient {
    ...
    /**
     * Helper which obtains an authorization code for your API via opening a popup window in the user's browser
     * @param validRequest
     * @param popupName
     * @param popup
     ...
     */
    protected async acquireAuthorizationCodePopupAsync(
        request: PopupRequest,
        popupName: string,
        popupWindowAttributes: PopupWindowAttributes,
        popup?: Window | null
    ): Promise<ServerAuthorizationCodeResponse> {
        this.logger.verbose("acquireAuthorizationCodePopupAsync called");
